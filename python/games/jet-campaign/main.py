...
supply_sound = pygame.mixer.Sound("material/sound/bullet.wav")
supply_sound.set_volume(0.2)
get_bomb_sound = pygame.mixer.Sound("material/sound/get_bomb.wav")
get_bomb_sound.set_volume(0.2)
get_bullet_sound = pygame.mixer.Sound("material/sound/get_bomb.wav")
get_bullet_sound.set_volume(0.2)
upgrade_sound = pygame.mixer.Sound("material/sound/bullet.wav")
upgrade_sound.set_volume(0.2)
enemy3_fly_sound = pygame.mixer.Sound("material/sound/enemy2_out.wav")
...
me_down_sound = pygame.mixer.Sound("material/sound/get_bomb.wav")
...
def main():
    ...
    # 标志是否暂停游戏
    paused = False
    paused_nor_image = pygame.image.load("material/image/game_pause_nor.png").convert_alpha()
    paused_pressed_image = pygame.image.load("material/image/game_pause_pressed.png").convert_alpha()
    ...
    while running:
        ...
        if paused:
            ...
            if life_num == 0:
                ...
                again_image = pygame.image.load("material/image/btn_finish.png").convert_alpha()
